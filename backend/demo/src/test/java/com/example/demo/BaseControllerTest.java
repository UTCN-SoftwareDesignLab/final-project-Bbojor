...
public abstract class BaseControllerTest {
    ...
    protected ResultActions performGetWithModelAttribute (String path, Pair<String, Object> modelAttribute) throws Exception {
        MockHttpServletRequestBuilder requestBuilder = get(path);
        requestBuilder.flashAttr(modelAttribute.getLeft(), modelAttribute.getRight());
